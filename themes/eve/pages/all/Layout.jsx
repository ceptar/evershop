...
import { useScrollSensitiveNav } from './hooks/useScrollSensitiveNav';
import "../../css/global.scss";
import "./Layout.scss";
import "./tailwind.scss";

export default function Layout() {
  const { navColor } = useScrollSensitiveNav();
  return (
    <>
      <LoadingBar />
      <div className="header fixed top-0 left-0 z-10 h-16" style={{ backgroundColor: navColor, position: "sticky", top: 0, transition: "all 1s"}}>
